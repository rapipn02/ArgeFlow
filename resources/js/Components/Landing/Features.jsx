...
function FeatureCard({ feature, index }) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-blue-50/10 to-blue-60/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
