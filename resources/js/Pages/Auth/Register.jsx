                    ...
                    <div className="relative z-10 flex flex-col justify-center p-12 lg:p-16 text-white">
                        ...
                        <div className="space-y-6 mb-12">
                            <h1 className="text-4xl lg:text-5xl font-bold leading-tight">
                                Bergabung dengan<br />
                                Ribuan Pengguna<br />
                                <span className="text-emerald-300">Hari Ini</span>
                            </h1>
                            <p className="text-lg text-white/80 max-w-md">
                                Mulai proyek digital Anda bersama programmer terbaik
                            </p>
                        </div>
                    ...
                    <div className="w-full max-w-md space-y-8 relative z-10">
                        ...
                        <div className="text-center space-y-2">
                            ...
                            <p className="text-muted-foreground">
                                Buat akun untuk mengakses semua fitur platform
                            </p>
                        </div>
